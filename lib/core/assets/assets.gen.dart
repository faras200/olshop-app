...
class $AssetsImagesGen {
  ...
  AssetGenImage get banner1Jpg =>
      const AssetGenImage('assets/images/banner1.jpg');

  /// File path: assets/images/banner1.png
  AssetGenImage get banner1Png =>
      const AssetGenImage('assets/images/banner1.png');

  /// File path: assets/images/banner2.jpg
  AssetGenImage get banner2Jpg =>
      const AssetGenImage('assets/images/banner2.jpg');

  /// File path: assets/images/banner2.png
  AssetGenImage get banner2Png =>
      const AssetGenImage('assets/images/banner2.png');
